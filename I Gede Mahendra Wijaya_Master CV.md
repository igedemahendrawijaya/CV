...
2. **Biodiversity Finance: Designing and Implementing Finance Plans for Nature** — [UNDP Biodiversity Finance Initiative (BIOFIN) & Learning for Nature](https://www.learningfornature.org/en/courses/biodiversity-finance-designing-and-implementing-finance-plans-for-nature-self-paced/) *(Sep 2026)*
...
3. **ICAT Training on the Use of the IPCC Inventory Software** — [Initiative for Climate Action Transparency (ICAT), IPCC TSU & UNDP Learning for Nature](https://www.learningfornature.org/en/courses/icat-training-on-the-use-of-the-ipcc-inventory-software/) *(Sep 2026)*
